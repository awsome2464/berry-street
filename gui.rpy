...
define gui.hover_color = '#d0d0d0'

## The color used for a text button when it is selected but not focused. A
## button is selected if it is the current screen or preference value.
define gui.selected_color = '#00b700'
...
define gui.muted_color = '#8e8e8e'
define gui.hover_muted_color = '#8e8e8e'
...
define gui.game_menu_background = "gui/pause_bg.png"
...
define gui.slot_button_width = 960
define gui.slot_button_height = 540
