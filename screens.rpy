...
style window:
    ...
    background Image(persistent.ziphtech_label, xalign=0.5, yalign=1.0)
...
screen navigation():
    ...
    #     xalign 0.5
    #     yalign 0.8
    #     textbutton "Reset" action Jump("newgame")
    #     textbutton "CD":
    #         if persistent.customdialogue == True:
    #             action ToggleVariable("persistent.customdialogue", False)
    #         elif persistent.customdialogue == False:
    #             action ToggleVariable("persistent.customdialogue", True)
    ...
    #     imagebutton auto "gui/quit_%s.png" action Quit()
    #
    #     spacing 10
    ...
    hbox:
        ...
        spacing 10
        #textbutton "Reset" action Jump("newgame")
        #textbutton "Day Select" action ShowMenu('dayselect')
        #textbutton "Check Update" action updater.Update("https://raw.githubusercontent.com/awsome2464/berry-street-update/master/updates/updates.json")
    ...
    hbox:
        ...
        imagebutton auto "gui/extras_%s.png" action ShowMenu('extras')
...
screen main_menu():
    ...
    if persistent.elie_completed:
        add "eleanor_title" xalign 0.0 yalign 0.5
    if persistent.don_completed:
        add "donald_title" xalign 1.0 yalign 0.5
    if persistent.chris_completed:
        add "christeena_title" xalign 0.2 yalign 0.1
    if persistent.brit_completed:
        add "brittney_title" xalign 0.78 yalign 0.2
    if persistent.brit_completed and persistent.chris_completed and persistent.don_completed and persistent.elie_completed:
        add "alex_title":
            xalign 0.5
            ypos 0.05
    add "title_logo" xalign 0.5 yalign 0.03
    text "[persistent.Build_Name]" style "build" xalign 0.99 yalign 0.99
...
screen save():
    ...
    add 'gui/pause.png' xalign 0.5 yalign 0.05
                ...
                frame:
                    ...
                    button:
                        ...
                        vbox:
                            xalign 0.5
                            yalign 0.5
                            if persistent.progress == 0:
                                add "BG/Sprouse House.png" size (960, 540)
                            elif persistent.progress == 1:
                                add "BG/Berry Street.png" size (960, 540)
                            elif persistent.progress == 2:
                                add "BG/Dolmart Interior.png" size (960, 540)
                            elif persistent.progress == 3:
                                add "BG/Living Room Moving.png" size (960, 540)
                            elif persistent.progress == 4:
                                add "BG/Mall Interior.png" size (960, 540)
                            elif persistent.progress == 5:
                                add "BG/Cabin Exterior Sunset.png" size (960, 540)
...
screen preferences():
    ...
    add "gui/options_idle.png" xalign 0.95 yalign 0.05
    ...
    hbox:
        ...
        frame:
            ...
            hbox:
                ...
                textbutton "Load" action ShowMenu('load') xalign 1.0
                textbutton "Title" action MainMenu(confirm=True)
