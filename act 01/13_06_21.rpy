label unpack0621:
    ...
    stop loop
    a "Yeah?"
    d "{font=fonts/LemonMilk.otf}{i}Hey, wassup?{/i}{/font}"
    a "Unpacking."
    d "{font=fonts/LemonMilk.otf}{i}Again??{/i}{/font}"
    a "Can't help it; Mom wants everything unpacked ASAP."
    d "{font=fonts/LemonMilk.otf}{i}Well, that blows.{/i}{/font}"
    a "Yeah, tell me about it."
    d "{font=fonts/LemonMilk.otf}{i}Well, how much more do you have?{/i}{/font}"
    a "In the whole house? I mean, not too much more; just some stuff in the living room and then our bedrooms."
    d "{font=fonts/LemonMilk.otf}{i}But it's easier said than done?{/i}{/font}"
    a "Heh. Pretty much."
    d "{font=fonts/LemonMilk.otf}{i}Hm...{/i}{/font}"
    "Uh oh. {w=.5}I've heard that 'Hm' before; that's Donald's 'I've got an idea' noise."
    d "{font=fonts/LemonMilk.otf}{i}Alright, Man. I'll talk to you later.{/i}{/font}"
    a "Alright. See ya!"
    ...
    pause 0.5
    show don p1 straight casual grin:
        zoom 1.0
        xalign 0.9 yalign 0.2
    show chris p2 straight casual grin:
        zoom 1.0
        xalign .1 yalign .25
    with dissolve
    pause 0.1
    ...
    g "Really? Well, how thoughtful of them!"
    ...
    show don:
        ease 0.5 middle
    show ginger p2 straight sad grin at threeright with easeinright
    pause 0.1
    ...
    g casual wide "Ah, where are my own manners?"
    show ginger:
    ...
    c p1 grin "Yeah, that's me. Christeena Truman. That's Christeena with two 'e's"
    g sad "Ah, what a cute way of spelling it."
    $ c_blush = True
    c left sad "T-thanks."
    g casual "I'm Ginger, Alex's mother. It's nice to finally meet you."
    $ c_blush = False
    show chris p2 straight casual grin at threeleft
    c "Likewise."
    g "Anyway, come on in!"
    ...
    pause 0.5
    scene bg living_s_m with dissolve
    show ginger p2 casual grin straight at middle with dissolve
    pause 0.1
    ...
    show don p1 raised grin straight at threeright
    with dissolve
    pause .1
    ...
    c p1 level "So, where do Donald and I go?"
...
label c_cleanroom:
    ...
    with easeoutright
    pause 0.1
    c p2 sad dot "Are you sure? I mean, I don't think I'd really know where everything in a boy's room would go..."
    ...
    c blank "Well..."
    c p1 grin "Well...{fast}okay. I guess I can handle that."
    show don straight casual smile p1 at tworight
    ...
    "After telling him that at least, unlike him, I could get a girl in my room, he laughed and went into his own room to finish his unboxing. Christeena couldn't help but smile a little bit."
    $c_blink = False
    show chris p1 closed_happy sad smile at close_c with dissolve
    pause 0.1
    c "Now I see how you can put up with Brittney!"
    a "Speaking of which, what time does she get off work today?"
    $c_blink = True
    c p2 straight casual grin "5 o'clock, so only a few more hours."
    ...
    show chris p1 straight dot casual at close_c with dissolve
    pause 0.1
    ...
    c p2 blank "Is there any specific way you want them arranged?"
    ...
    c p1 casual grin "I like the sound of that!"
    ...
    show chris p2 straight casual blank at tworight with dissolve
    pause 0.1
    ...
    $ c_blush = False
    $ c_blink = True
    show chris p1 straight casual grin at tworight
    ...
    c p2 smile "Hey, she is not short! She's average height for someone her age!"
    ...
    c p1 left mad blank "Ugh..."
    a "What's her deal, anyway?"
    c straight "No fuckin' clue. It's like she's a robot programmed to piss everyone off."
    c p2 "And how she treated your brother... that's just unacceptable!"
    "I had told the guys about the run-in I had with Eleanor when I was shopping at Dolmart. Their reactions were just as I'd expected: Donald disappointed, Brittney shocked, and Christeena pissed."
    ...
    c p1 sad dot "You mean he doesn't know??"
    ...
    c p2 left blank level "Well, yeah, maybe for the summer. Once school starts, though..."
    a "Though I'm glad I'm not crazy when I said I think that she looks too old to be a high schooler."
    c p1 straight casual "Yeah, her being held back is crazy! Why would you want to be in high school for longer than necessary??"
    ...
    c p2 straight casual blank "Anna Ziphon. And I'm honestly not surprised you haven't met her yet; she's the biggest hermit I know. Half the time, I forget she even exists."
    a "So does she really have a laboratory in her house or whatever?"
    c p1 dot left level "That's what everyone says, though none of us have actually been in it."
    ...
    c p2 left sad grin "Yeah, it truly does baffle me how I got stuck with a sister like her."
    ...
    show chris p2 straight casual grin at tworight with easeinright
    pause 0.1
    ...
    c p2 casual "What kind of things do you read?"
    ...
    c p1 left level dot "I don't know about 'bookworm'... I'm not really obsessed with reading or anything like that."
    ...
    c p2 left level "I...{w=1.0} am not sure how to respond to that..."
    a_s "..."
    ...
    $ c_blush = True
    c p1 sad hanging "I-I'm not disappointed!"
    ...
    $ c_blush = False
    show chris p2 straight casual blank at tworight
    c "Stephen King?"
    a "R.L. Stine."
    c left grin level "Ah."
    c p1 straight sad "Well, at least you read some decent stories by decent authors."
    ...
    $c_blink = False
    c p2 closed_happy sad smile "Yes!"
    "We high-five each other in celebration before heading down to the living room."
    scene bg living_s_m with dissolve
    $c_blink = True
    a "Well, we're done in my bedroom!"
    show ginger p2 level blank straight at twoleft
    show don p1 straight blank casual at tworight
    with dissolve
    pause 0.1
    ...
    show don at middle
    show chris p1 straight casual grin at threeright
    with easeinright
    pause 0.1
    ...
    $ c_blush = True
    $ c_blink = False
    c p2 closed_happy sad "Don't worry; we both worked hard to get it all finished."
    d raised grin right "Did I just hear Christeena Renee Truman say, with a confident smile, that she worked hard?"
    $ c_blush = False
    $ c_blink = True
    show chris p2 straight mad grin at threeright
    c "Screw you."
    scene bg living_s_m with dissolve
    pause 0.1
    jump dadcomeshome
...
label d_cleanroom:
    ...
    show chris:
        ease 0.5 xalign 0.1
    show ginger p2 raised grin straight at middle with dissolve
    pause 0.1
    ...
    c p1 straight mad hanging "Of course not!"
    ...
    show don p1 straight blank casual at tworight with dissolve
    pause 0.1
...
label finishclean_don:
    ...
    scene bg living_s_m with dissolve
    pause 0.1
    show ginger p2 casual straight blank at tworight
...
label dadcomeshome:
    ...
    show fred p1 straight glasses grin casual at middle with dissolve
    pause 0.1
    f "I'm home!"
    ...
    show don p1 straight casual smile at threeleft
    with easeinleft
    pause 0.1
    d "Hey, Mr. Sprouse!"
    ...
    c p1 "How old were you when you had Alex, anyway? 35?"
    f mad "24."
    c_s small sad dot "...!"
    $ c_blush = True
    c p2 straight blank "U-Um..."
...
label teasechris:
    ...
    $ c_blush = False
    show chris p2 blank straight casual at threeright
    show don straight
    c "Eh?"
    ...
    c p1 sad grin "R-Right! That's what I was doing!"
...
label grayhair:
    ...
    show chris at middle
    show ginger p2 straight sad grin at threeright
    with easeinright
    pause 0.1
    ...
    show don p1 grin straight casual at threeleft with easeinleft
    pause .1
    ...
    $ c_blush = False
    c blank straight sad p1 "A-Are you sure it won't be a problem, Mrs. Sprouse?"
    ...
    c p2 straight casual grin "Sounds good to me!"
    $ current_track = "None"
    ...
    show don p1 grin casual straight at twoleft
    show chris p1 straight grin casual at tworight
    with dissolve
    pause 0.1
    ...
    c p1 left grin mad "Yeah, yeah..."
    c p2 straight casual "Still, it was pretty cool to meet your family. They seem like nice people."
    a "Indeed, they do."
    c_s p2 level blank "..."
    a_s "..."
    a "Anyway, it's a shame that Brittney couldn't at least be here for dinner. Maybe next time?"
    c p1 left grin "Maybe... Depends on if she's in the mood for something like that."
