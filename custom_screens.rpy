...
screen music_room():
    ...
    frame:
        ...
        vbox:
            ...
            textbutton "14. The Pond" action [ToggleVariable('persistent.current_track', 'The Pond'), mr.Play("audio/music/The Pond.ogg")]
            textbutton "15. Outside the Street" action [ToggleVariable('persistent.current_track', 'Outside the Street'), mr.Play("audio/music/Outside the Street.ogg")]
            textbutton "16. Dinin' In" action [ToggleVariable('persistent.current_track', 'Dinin\' In'), mr.Play("<loop 9.6>audio/music/Dinin' In.ogg")]
            textbutton "17. Getting Educated" action [ToggleVariable('persistent.current_track', 'Getting Educated'), mr.Play("<to 108 loop 4>audio/music/Getting Educated.ogg")]
            textbutton "18. The Mall" action [ToggleVariable('persistent.current_track', 'The Mall'), mr.Play("<loop 15>audio/music/The Mall.ogg")]
            textbutton "19. Friendly Competition" action [ToggleVariable('persistent.current_track', 'Friendly Competition'), mr.Play("audio/music/Friendly Competition.ogg")]
            textbutton "20. Cabin Fever" action [ToggleVariable('persistent.current_track', 'Cabin Fever'), mr.Play("<loop 8>audio/music/Cabin Fever.ogg")]
            textbutton "21. Sunday Service" action [ToggleVariable('persistent.current_track', 'Sunday Service'), mr.Play("audio/music/Sunday Service.ogg")]
            textbutton "22. Generic 80s Song" action [ToggleVariable('persistent.current_track', 'Generic 80s Song'), mr.Play("audio/music/Generic 80s Song.ogg")]
            textbutton "23. From the Heart" action [ToggleVariable('persistent.current_track', 'From the Heart'), mr.Play("audio/music/From the Heart.ogg")]
