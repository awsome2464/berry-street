...
label choice9:
    ...
    if persistent.choice_9 == 1:
        "Hmm...{w} Who do I want to help me work on my room?"
        "Well..."
        jump d_cleanroom
    elif persistent.choice_9 == 2:
        "Hmm...{w} Who do I want to help me work on my room?"
        "Well..."
        jump c_cleanroom
    else:

        "Hmm...{w} Who do I want to help me work on my room?{nw}"

        menu:

            "Hmm... Who do I want to help me work on my room?{fast}"

            "Donald":
                $ persistent.choice_9 = 1
                jump d_cleanroom

            "Christeena":
                $ persistent.choice_9 = 2
                jump c_cleanroom
...
label c_cleanroom:
    ...
    pause .1
    c "Now I see how you can put up with Brittney; your brother's like a younger, male version of her!"
...
label d_cleanroom:
    ...
    if persistent.choice_10 == 1:
        jump iguess
    elif persistent.choice_10 == 2:
        jump notreally
    else:
        ...
        menu:
            ...
            "I guess.":
                $ persistent.choice_10 = 1
                jump iguess

            "Not really.":
                $ persistent.choice_10 = 2
                jump notreally
...
label grayhair:
    ...
    $ c_blush = False
    show chris blank straight sad b1 at middle
    c "A-Are you sure it won't be a problem, Mrs. Sprouse?"
    ...
    narrate "With that, we all sat on the couch and I turned on the TV."
    narrate "We eventually settled on an old movie from the early 2000s that was pretty cheesy, but so nostalgic that we couldn't help but love it."
    narrate "As promised, dinner was ready in a couple hours. Tonight, it was meatloaf."
    narrate "I had texted Brittney and asked if she wanted to join us, even making it clear that her sister and other next-door neighbor were here, but she politely declined."
    nvl clear
    narrate "It was a little weird sitting around the table with 2 extra people sitting in chairs that didn't match the other 4, but oh well."
    narrate "As per usual, Donald was talkative, making most of the dinner conversation between him and my parents."
    narrate "Personally, I didn't mind; I'm not the kind of guy who likes to talk while eating a meal."
    narrate "Occasionally, he would get me, Christeena, and/or Harry to contribute a bit, but we were silent for the most part."
    narrate "Although, at one point, Christeena did ask my dad where he worked."
    narrate "He explained that he worked with Mr. Waters at the grain elevators in town. It was busy and tiring, but the pay was decent enough."
    narrate "I hadn't really spent much time outside of Chicago before moving to Smalltown, but from what I could see, agriculture and farming are big in the rest of the state."
    narrate "It really does continue to amaze me how that one city is so unlike the rest of Illinois."
    nvl clear
    nvl hide dissolve
    window show dissolve
    ...
    if delihangout:
        "I suppose that would explain her behavior that day when Harry and I were at Kelly's... {w=1}Did I really make the right decision by going against her request to eat alone...?"
    else:
        "I suppose that would explain her behavior that day when Harry and I were at Kelly's... {w=1}Did I really make the right decision by allowing her to eat alone...?"
