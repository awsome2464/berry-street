...
# Kelly's Deli
    ...
    k raised "Oh, hey! You're Donald's friend, right?{fast} Alan, is it?"
    a "Alex."
    k sad "Alex! Right!"
    ...
    h mad blank "Yeah, no kidding!{fast} Though it sucks that we have to spend part of our summer unboxing everything."
    ...
    $b_blink = False
    hide harry with easeoutright
    show brit a1 closed opened_smile sad:
        size(720, 1440)
...
label choice8:
    ...
    if persistent.choice_8 == 1:
        "Hmm..."
        jump brithangout
    elif persistent.choice_8 == 2:
        "Hmm..."
        jump leavebritalone
    else:
        ...
        menu:
            ...
            "Hang out with Brittney.":
                $ persistent.choice_8 = 1
                jump brithangout

            "Leave Brittney alone.":
                $ persistent.choice_8 = 2
                jump leavebritalone
