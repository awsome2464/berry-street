label firstday:
    ...
    python:
        if warning_selector == 1:
            ...
            warning_message = "We thank you for your cooperation and wish you the best of luck."
...
label firstdayreplay:
    ...
    if persistent.choices["1"] == 1:
        jump whateveryousay
    elif persistent.choices["1"] == 2:
        jump dontwantastart
    else:
        menu:
            a "..."
            "Whatever you say.":
                $ persistent.choices["1"] = 1
                jump whateveryousay
            "I don't want a fresh start.":
                $ persistent.choices["1"] = 2
                jump dontwantastart
...
label continuemoveconvo:
    ...
    show don raised
    bd "Alex?"
    if persistent.choices["2"] == 1:
        a "Hm..."
        jump videogames_b
    elif persistent.choices["2"] == 2:
        a "Hm..."
        jump basketball_b
    else:
        a "Hm...{nw}"
        menu:
            ...
            "Video Games.":
                $ persistent.choices["2"] = 1
                jump videogames_b

            "Basketball.":
                $ persistent.choices["2"] = 2
                jump basketball_b
    ...
    label hangout_b:
        ...
        if B_Basketball:
            scene bg basketball_w with dissolve
            nvl show dissolve
            pause 0.1
        ...
        d "So, Alex..."
        if persistent.choices["3"] == 1:
            d "What do you think of her?"
            jump britisfunny
        elif persistent.choices["3"] == 2:
            d "What do you think of her?"
            jump britischill
        elif persistent.choices["3"] == 3:
            d "What do you think of her?"
            jump britisattractive
        elif persistent.choices["3"] == 4:
            d "What do you think of her?"
            ...
            menu:
                ...
                "She's funny.":
                    $ persistent.choices["3"] = 1
                    jump britisfunny

                "She's chill.":
                    $ persistent.choices["3"] = 2
                    jump britischill

                "She's attractive.":
                    $ persistent.choices["3"] = 3
                    jump britisattractive

                "She's interesting.":
                    $ persistent.choices["3"] = 4
                    jump britisinteresting
